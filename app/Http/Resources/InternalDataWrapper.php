...
class InternalDataWrapper
{
    ...
    public function __construct($request)
    {
        ...
        switch ($this->requestType) {
            ...
            case 'abWhitelist':
                $this->payload = $this->GenerateAbWhitelistPayload($request);
                break;
        }
    }
    ...
    public function GenerateAbWhitelistPayload($request)
    {
        ...
        $payload = [
            ...
            'domainNames' => explode(',', $request->domains), // Split domainNames into an array
            'validate' => 'true',
        ];
